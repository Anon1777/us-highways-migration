<?php include "../../../static/top.php"; ?>
            ...
            <?php include "../../../static/table.php"; ?>
                <tr>
                    ...
                    <td class="content text-dark"><a href="../../interstates/auxiliary/nj-278.php">I-278 (EB) - Goethals Brg</a>, Elizabeth, New Jersey 07202</td>
                ...
                <tr>
                    ...
                    <td class="content text-dark"><a href="../../interstates/auxiliary/nj-278.php">I-278 (WB) - Goethals Brg</a>, Elizabeth, New Jersey 07202</td>
                ...
                <tr>
                    <td class="content text-dark small">0.87 mi ( + 0.06 mi )</td>
                    <td class="content text-dark small">1.40 km ( + 0.10 km )</td>
                    <td class="content text-dark"></td>
                ...
                <tr>
                    <td class="content text-dark small">1.43 mi ( + 0.43 mi )</td>
                    <td class="content text-dark small">2.30 km ( + 0.69 km )</td>
                ...
                <tr>
                    <td class="content text-dark small">2.13 mi ( + 0.11 mi )</td>
                    <td class="content text-dark small">3.43 km ( + 0.17 km )</td>
                ...
                <tr>
                    <td class="content text-dark small">2.50 mi ( + 0.13 mi )</td>
                    <td class="content text-dark small">4.03 km ( + 0.21 km )</td>
                    <td class="content text-dark"></td>
                    <td class="content text-dark">North Ave, Elizabeth, New Jersey 07202</td>
                    <td class="content text-dark"></td>
                </tr>
                <tr>
                    <td class="content text-dark small">2.74 mi ( + 0.24 mi )</td>
                    <td class="content text-dark small">4.42 km ( + 0.39 km )</td>
                    <td class="content text-dark"></td>
                ...
                <tr>
                    <td class="content text-dark small">3.04 mi ( + 0.08 mi )</td>
                    <td class="content text-dark small">4.89 km ( + 0.12 km )</td>
                    <td class="content text-dark"></td>
                    <td class="content text-dark">North Ave, Hillside, New Jersey 07205</td>
                    <td class="content text-dark"></td>
                </tr>
                <tr>
                    <td class="content text-dark small">3.57 mi ( + 0.53 mi )</td>
                    <td class="content text-dark small">5.74 km ( + 0.85 km )</td>
                    <td class="content text-dark"></td>
                    <td class="content text-dark">North Ave, Elizabeth, New Jersey 07202</td>
                    <td class="content text-dark"></td>
                </tr>
                ...
                <tr>
                    <td class="content text-dark small">4.10 mi ( + 0.31 mi )</td>
                    <td class="content text-dark small">6.58 km ( + 0.49 km )</td>
